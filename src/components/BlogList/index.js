                            ...
                            {blogs.map((blog, bitem) => (
                                <div className={`post  ${blog.blClass}`}key={bitem}>
                                    ...
                                    <div className="entry-meta">
                                        <ul>
                                            <li><i className="fi flaticon-user"></i> By <Link onClick={ClickHandler} href={`/blog-single/${blog.id}`}>{blog.authorTitle}</Link> </li>
                                    ...
                                    <div className="entry-details">
                                        <h3><Link onClick={ClickHandler} href={`/blog-single/${blog.id}`}>{blog.title}</Link></h3>
                                        ...
                                        <Link onClick={ClickHandler} href={`/blog-single/${blog.id}`} className="read-more">READ MORE...</Link>
                                    </div>
                                </div>
                            ))}
